...
<?php
  ...
  require("../config/conexion.php");
    ...
    $query = "SELECT * FROM puertos AS P, itinerarios AS I1, buques AS B1 WHERE LOWER(P.nombre_puerto) LIKE LOWER('%$nombre_puerto%') AND I1.pid = P.pid AND LOWER(B1.nombre) LIKE LOWER('%$nombre_buque%') AND I1.bid = B1.bid;
