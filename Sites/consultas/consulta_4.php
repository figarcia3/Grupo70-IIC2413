...
<?php
  ...
  require("../config/conexion.php");
    ...
    $query = "CREATE VIEW in_MM 
              SELECT I1.fecha_atraque, I1.fecha_salida 
              FROM puertos AS P, itinerarios AS I1, buques AS B1 
              ...
              AND I2.pid = P.pid 
              AND B2.bid = I2.bid 
              AND I2.fecha_atraque>= MM.fecha_atraque 
              AND I2.fecha_atraque<=MM.fecha_salida;";
